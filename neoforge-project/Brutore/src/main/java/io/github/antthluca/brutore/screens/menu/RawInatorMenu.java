...
package io.github.antthluca.brutore.screens.menu;
...
public class RawInatorMenu extends AbstractContainerMenu {
    ...
    public final RawInatorBlockEntity blockEntity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, InitBlocks.RAW_INATOR.get());
    }
    ...
    public RawInatorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(InitMenuTypes.RAW_INATOR_MENU.get(), pContainerId);
        this.blockEntity = ((RawInatorBlockEntity) entity);
        ...
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 54, 38));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 111, 38));
